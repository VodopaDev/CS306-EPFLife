...
public class AddAssociationArrayAdapter extends ArrayAdapter<Association> {

    private static final int layout_resource_id = R.layout.add_card_association;
     ...
     */
    public AddAssociationArrayAdapter (Context context, List<Association> data, View.OnClickListener mListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final AddAssociationArrayAdapter.AssociationHolder holder = asso_view == null ? new AddAssociationArrayAdapter.AssociationHolder() : (AddAssociationArrayAdapter.AssociationHolder) asso_view.getTag();

        if (asso_view == null) {
            LayoutInflater inflater = ((Activity) context).getLayoutInflater();
            asso_view = inflater.inflate(layout_resource_id, parent, false);

            holder.name = asso_view.findViewById(R.id.add_card_asso_name);
            holder.short_desc = asso_view.findViewById(R.id.add_card_asso_short_desc);
            holder.icon = asso_view.findViewById(R.id.add_card_asso_image);
            holder.add_button = asso_view.findViewById(R.id.add_card_add_button);
